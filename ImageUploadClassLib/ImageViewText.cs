...
namespace ImageUploadClassLib
{
    class ImageViewText
    {
        ...
        public static HttpResponseMessage Run(HttpRequestMessage req, IQueryable<ImageText> inputTable, 
                                              CloudBlobContainer inputContainer, TraceWriter log)
        {
        ...
        // TBD -  should be done once every 24 hours via timer, rather than each time in the funciton 
